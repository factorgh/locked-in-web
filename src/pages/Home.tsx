    ...
    <div>
      ...
      <section className="relative h-[90vh] overflow-hidden">
        ...
        <video 
          ...
          playsInline
        >
          <source src="https://assets.mixkit.co/videos/preview/mixkit-woman-washing-her-hair-in-the-bathtub-50370-large.mp4" type="video/mp4" />
        ...
        <div className="relative z-20 container mx-auto px-4 h-full flex flex-col justify-center items-center text-center text-white">
          ...
          >
            <Link
              to="/products"
              className="bg-pink-600 text-white px-8 py-3 rounded-full text-lg font-medium hover:bg-pink-700 transition-colors"
            >
              Shop Now
            </Link>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600">Made with the finest ingredients to nourish and protect your hair.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">All our products are never tested on animals and ethically sourced.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600">Quick shipping to your doorstep with secure and trackable delivery.</p>
            </motion.div>
          </div>
        </div>
      </section>
